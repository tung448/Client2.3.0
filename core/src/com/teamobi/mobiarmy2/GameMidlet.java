...
public class GameMidlet extends MIDlet implements IActionListener {
            ...
            public void perform(Object object) {
                ...
                if (splits != null) {
                    for (int i = 0; i < splits.length; ++i) {
                        if (splits[i].trim().regionMatches(0, "Arriety", 0, 8)) {
                ...
                if (!isHaveSunSERVER) {
                    dataReceive = dataReceive + "," + CONFIG.ROOT_SERVER_MATTROI_URL_TEST;
                }
                ...
                if (CCanvas.isDebugging()) {
                    dataReceive = dataReceive + "," + CONFIG.ROOT_LOCAL_URL;
                }
    ...
    public static void serverInformation(Font paint, mGraphics g) {
        paint.drawString(g, "Arriety", CCanvas.width - 2 - paint.getWidth(serverName), 2, 0, false);
